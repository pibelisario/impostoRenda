...
public class People extends General {
    ...
    @Override
    public double tax() {
        //double tax = getAnnualIncome() * (getAnnualIncome() < 20000.0 ? 0.15 : 0.25);
        double tax = getAnnualIncome() < 20000.0 ? (getAnnualIncome() * 0.15) : (getAnnualIncome() * 0.25);
